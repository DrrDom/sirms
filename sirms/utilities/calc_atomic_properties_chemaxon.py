...
def main():
    ...
    parser.add_argument('-c', '--cxcalc_path', metavar='path-to-cxcalc', default="cxcalc",
                        help='if necessary specify the path to cxcalc executable file. It is usually '
